        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460]">
                ...
                <div className="absolute inset-0">
                    ...
                    <div
                        className="absolute bottom-20 right-20 w-96 h-96 bg-[#d4a574]/10 rounded-full blur-3xl animate-pulse"
                ...
                <div className="relative z-10 flex flex-col justify-center px-16">
                    <div className="mb-8">
                        ...
                        <p className="text-lg text-white/60 max-w-md">
                            Admin dashboard for managing your church website
                            content, events, sermons, and live streams.
                        </p>
                    </div>
