                        ...
                        {[
                            ...
                            <Reveal key={i} delayMs={100 + i * 100}>
                                <div className="group bg-gradient-to-br from-[#FFF8F0] to-[#FFF1E2] p-8 text-left border-b-4 border-[#F2C79B] rounded-xl card-hover">
                                    ...
                                    <h3 className="font-bold text-xl mb-3 group-hover:text-[#c9a27e] transition-colors">
                                        {item.title}
                                    </h3>
                ...
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <Reveal delayMs={60}>
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto mb-8 leading-relaxed">
                            At House of His Grace, we are driven by the love of
                            Christ to serve, uplift, and transform lives through
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            {
                                src: "/images/group22.jpg",
                                alt: "Fellowship together",
                            },
                            {
                            ...
                            {events.slice(0, 4).map((event, i) => (
                                <Reveal key={event._id} delayMs={100 + i * 80}>
                                    <div className="group bg-gradient-to-br from-[#FFF8F0] to-[#FFF1E2] p-6 rounded-xl card-hover border border-[#F2C79B]/20">
                                        ...
                                        <h3 className="font-bold text-lg mb-2 group-hover:text-[#c9a27e] transition-colors">
                                            {event.title}
                                        </h3>
                        ...
                        <Reveal delayMs={60}>
                            <div className="text-center mb-12">
                                ...
                                <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                                    Hear from our church family about how God
                                    has transformed their lives through faith
                                    and community.
                                </p>
                            </div>
                        </Reveal>
                ...
                <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                    <Reveal delayMs={60}>
                        ...
                        <p className="text-white/60 max-w-2xl mx-auto mb-8 leading-relaxed">
                            We exist to glorify God by making disciples who love
                            Him, love one another, and serve the world. Come and
