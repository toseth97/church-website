          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="lg:col-span-1">
              <Link href="/" className="flex items-center gap-3 group mb-6">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#F2C79B] to-[#d4a574] flex items-center justify-center font-bold text-black text-xl transition-transform duration-300 group-hover:scale-110">
                  H
                </div>
                <div>
                  ...
                  <span className="text-[#F2C79B]/70 text-xs tracking-widest uppercase">
                    House of His Grace
                  </span>
                </div>
              </Link>
              <p className="text-white/60 text-sm leading-relaxed mb-6">
                A church of faith, hope, and love. Join us in worship and
                community as we grow together in the grace of God.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={service.day} className="flex flex-col">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[#F2C79B] mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-[#F2C79B] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <a href="mailto:info@hhgc.org" className="text-white/50 hover:text-[#F2C79B] text-sm transition-colors">
                    info@hhgc.org
                  </a>
                </li>
                <li className="flex items-center gap-3">
                  ...
                  <a href="tel:+2341234567890" className="text-white/50 hover:text-[#F2C79B] text-sm transition-colors">
                    +234 123 456 7890
                  </a>
                </li>
              </ul>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                ...
                <p className="text-white/40 text-sm">
                  Join our mailing list for weekly devotionals and event updates.
                </p>
              </div>
          ...
          <div className="border-t border-white/5 pt-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-6 text-sm text-white/30">
                <Link href="/about" className="hover:text-[#F2C79B] transition-colors">
                  Privacy Policy
                </Link>
                <Link href="/about" className="hover:text-[#F2C79B] transition-colors">
                  Terms of Use
